#Codigos para Imagen de Complettnes ggplot2
library(ggplot2)
library("grid")
...
my_species <- c('UNJFSC003_busco', 'UNJFSC003_busco', 'UNJFSC003_busco', 'UNJFSC003_busco', 'FDAARGOS1428_busco', 'FDAARGOS1428_busco', 'FDAARGOS1428_busco', 'FDAARGOS1428_busco', 'CCA6_busco', 'CCA6_busco', 'CCA6_busco', 'CCA6_busco', 'Crenshaw_busco', 'Crenshaw_busco', 'Crenshaw_busco', 'Crenshaw_busco')
...
my_percentage <- c(99.1, 0.2, 0.0, 0.7, 98.9, 0.2, 0.2, 0.7, 98.4, 0.9, 0.2, 0.5, 98.9, 0.2, 0.2, 0.7)
my_values <- c(436, 1, 0, 3, 435, 1, 1, 3, 433, 4, 1, 2, 435, 1, 1, 3)
